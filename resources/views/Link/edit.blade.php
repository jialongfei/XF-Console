    ...
    <form class="layui-form" id="xForm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" value="{{$info->name}}" name="name" lay-verify="required" lay-reqtext="链接名称不能为空" placeholder="请输入链接名称" autocomplete="on" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" value="{{$info->link}}" name="link" placeholder="完整的URL,如: http://xf-world.org" class="layui-input">
            </div>
        </div>
        ...
        {{--            <div class="layui-input-block">--}}
        <input type="hidden" value="{{$info->icon}}" name="icon" placeholder="" class="layui-input">
        {{--            </div>--}}
        {{--        </div>--}}
