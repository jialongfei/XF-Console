    ...
    <form class="layui-form" id="xForm" enctype="multipart/form-data">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="position" lay-verify="required" lay-reqtext="请输入定位" placeholder="请输入定位" autocomplete="on" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="link" lay-verify="required" lay-reqtext="请输入链接地址" placeholder="请输入链接地址" class="layui-input">
            </div>
        </div>
        ...
        <input type="hidden" name="img_path" id="imgInput">
