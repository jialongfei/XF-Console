    ...
    <form class="layui-form" id="xForm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" lay-verify="required" lay-reqtext="角色名称不能为空" placeholder="请输入角色名称" autocomplete="on" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea name="description" placeholder="该角色的描述信息" class="layui-textarea"></textarea>
            </div>
        </div>
